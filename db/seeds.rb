...
{category: "metal" , descriptions: [{name: "Drinks cans", recyclability: true }, {name: "Food tins", recyclability: true}, {name: "Biscuit tins", recyclability: true }, {name: "Aluminium Trays and tubes", recyclability: true}, {name: "Aluminium foil", recyclability: true}, {name: "Laminated foil (that spring back when you try to scrunch them)", recyclability: false }, {name: "Shiny or glittery wrapping paper", recyclability: false }, {name: "Crisp packets", recyclability: false }, {name: "Sweetie wrappers", recyclability: false }, {name: "others", recyclability: false }]}]
