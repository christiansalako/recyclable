...
{category: "pet food" , descriptions: [{name: "Whiskas Fish in Jelly Senior 7+ cat food", url: "https://www.ocado.com/productImages/417/41768011_0_640x640.jpg?identifier=489d6acbaa5bc846bf2f8806d0eed86b"}, {name: "Felix As Good As It Looks Doubly Delicious Pouches", url: "https://www.ocado.com/productImages/265/265703011_0_640x640.jpg?identifier=b7f4b0f5dcbd204a32b3e48f3012944f"}, {name: "Felix cat food salmon", url: "https://shop-cdn-m.mediazs.com/bilder/felix/cat/food/cans/multibuy/x/g/3/400/3799_PLA_Felix_Haeppchen_in_Gelee_Lachs_Forelle_400g_3.jpg"}, {name: "Encore Cat Food Tuna And Shrimp cat food", url: "https://digitalcontent.api.tesco.com/v2/media/ghs/eddddd3e-5869-4298-9bfe-15a67a274586/snapshotimagehandler_1008919713.jpeg?h=540&w=540"}, {name: "Felix Christmas Goody Bag cat food", url: "https://www.ocado.com/productImages/732/73269011_0_640x640.jpg?identifier=d784dcfb43c040fa65d6f70d716addb4"}, {name: "Go-Cat Crunchy & Tender Beef & Chicken cat food", url: "https://www.ocado.com/productImages/828/82835011_0_640x640.jpg?identifier=655ba3302ed4bd4cd5d5a917227379dd"}]}]
...
Product.all.each_with_index do |product, index|
    case index
        ...
        when 4..6
            ...
            ProductMaterial.create(product_id: product.id, material_id: material.id)
            material = Material.where(name: "Non recyclable plastic")[0]
            ProductMaterial.create(product_id: product.id, material_id: material.id)
        when 7..14
            material = Material.where(name: "Non recyclable plastic")[0]
            ProductMaterial.create(product_id: product.id, material_id: material.id)
        ...
        when 26
            material = Material.where(name: "Cardboard")[0]
            ProductMaterial.create(product_id: product.id, material_id: material.id)
            material = Material.where(name: "Non recyclable paper")[0]
            ProductMaterial.create(product_id: product.id, material_id: material.id)
        when 27..28
            material = Material.where(name: "Cardboard")[0]
            ProductMaterial.create(product_id: product.id, material_id: material.id)
            material = Material.where(name: "Laminated foil")[0]
            ProductMaterial.create(product_id: product.id, material_id: material.id)
        when 29..30
            material = Material.where(name: "Food tin")[0]
            ProductMaterial.create(product_id: product.id, material_id: material.id)
